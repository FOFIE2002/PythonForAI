...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        if key.startswith('p'):
            print("{:20}: {:.1f}%".format(key.upper(), results_stats_dic[key]))

    # Prints incorrectly classified dogs if print_incorrect_dogs is True
    ...
    # Prints incorrectly classified dog breeds if print_incorrect_breed is True
