...
def get_pet_labels(image_dir):
    ...
    print("\Empty Dictionary results_dic - n items=", items_in_dic)
    filenames = ["beagle_0239.jpg", "Boston_terrier_02259.jpg"]
    pet_label = ["beagle", "boston terrier"]
    for idx in range(0, len(filenames), 1):
       if filenames[idx] not in results_dic:
            results_dic[filenames[idx]] = [pet_label[idx]]
       else:
           print("** Warning: key=", filename[idx], "already exists in results_dic with value =",results_dic[filenames[idx]])
